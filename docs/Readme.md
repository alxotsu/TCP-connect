# TCP-connect Тестовое задание для "ООО Интеллектуальные системы"
...
## Описание реализации
Проект выполнен в соответствии с заданием. Все логи ведутся в директории [logs](../logs).
Для запуска программы необходим интерпритатор Python 3.8 или выше. Перейдите в корневую директорию проекта и выполните команду
